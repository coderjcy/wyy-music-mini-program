...
__DEFINE__(1665216505739, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1665216505740,"./event-store":1665216505741}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1665216505740, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1665216505741, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1665216505740,"./utils":1665216505742}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1665216505742, function(require, module, exports) {
...
return __REQUIRE__(1665216505739);
})()
